...
@section('scripts')
    ...
    <script>
        $(function () {
                ...
                let deleteButton = {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        Swal.fire({
                            ...
                            text: `Anda akan menghapus ${ids.length} pelatih terpilih. Data tidak dapat dikembalikan!`,
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                ...
                                .done(function () { 
                                    Swal.fire('Terhapus!', 'Pelatih berhasil dihapus.', 'success').then(() => {
                                        location.reload();
                                    });
                                })
                                .fail(function() {
            ...
            $('.datatable-Employee').on('click', '.btn-danger[type="submit"]', function(e) {
                ...
                Swal.fire({
                    title: 'Hapus Pelatih?',
                    text: "Data pelatih yang dihapus tidak dapat dikembalikan!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#f86c6b', // Merah pastel
                    cancelButtonColor: '#6c757d',
