...
@section('content')
    <div class="card">
        <div class="card-header" style="font-weight: bold; font-size: 1.25rem; color: #2c3e50; border-bottom: 2px solid #f1f3f5;">
            {{ trans('global.list') }} {{ trans('cruds.service.title_singular') }}
        </div>
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            // Memasukkan Tombol "Tambah Service" ke dalam array dtButtons
            @can('service_create')
                let createButton = {
                    text: '<i class="fas fa-plus"></i> {{ trans('global.add') }} {{ trans('cruds.service.title_singular') }}',
                ...
                let deleteButton = {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        Swal.fire({
                            ...
                            text: `Anda akan menghapus ${ids.length} paket latihan terpilih. Data tidak dapat dikembalikan!`,
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                ...
                                .done(function () { 
                                    Swal.fire('Terhapus!', 'Paket latihan berhasil dihapus.', 'success').then(() => {
                                        location.reload();
                                    });
                                })
                                .fail(function() {
            ...
            $('.datatable-Service').on('click', '.btn-danger[type="submit"]', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Paket latihan yang dihapus tidak dapat dikembalikan!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#f86c6b', // Merah pastel
                    cancelButtonColor: '#6c757d',
